...
type HouseID int // Идентификатор дома.
...
type House struct {
	...
	CreatedAt *string `db:"created_at" example:"2017-07-21T17:32:28Z"`            // Дата создания дома.
	UpdateAt  *string `db:"update_at"  example:"2017-07-21T17:32:28Z"`            // Дата последнего добавления квартиры в дом.
}
